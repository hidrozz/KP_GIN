...
image_path = 'D:/KP_GIN/FILE 4/ConvertedImages/PDF4_5.jpg' 
...
# nama_index = words.index("bernama") + 1
# if nama_index < len(words):
#     words[nama_index] = "NY."
#     words[nama_index + 1] = "SUDI HARTONO"
#     selected_word = ' '.join(words[nama_index:nama_index+2])
#     print("Nama =", selected_word)
#     add_data_to_excel("Nama", selected_word)
# nik_index = words.index("NIK") + 2
# if nik_index < len(words):
#     words[nik_index] = "3404066107410002"
...
# Simpan
excel_file_path = os.path.join(excel_directory, 'PDF4.xlsx')
